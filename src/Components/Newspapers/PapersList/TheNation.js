...
export default class TheNation extends Component {
    _isMounted = false;
    cities = ["karachi", "lahore", "gwadar", "islamabad", "quetta"];
    ...
    async componentDidMount() {
        ...
        let data = await this.sendRequest(
            "https://api.codetabs.com/v1/proxy?quest=https://nation.com.pk/E-Paper/" +
                this.city
        );
        console.log(data);
        this.getImages(data);
