...
export default class Dunya extends Component {
    _isMounted = false;
    citiesNames = [
        "Islamabad",
        "Lahore",
    ...
    cities = ["KCH", "LHR", "MUL", "ISL", "GUJ", "FAB"];
    ...
    async componentDidMount() {
        ...
        let data = await this.sendRequest(
            "https://api.codetabs.com/v1/proxy/?quest=https://e.dunya.com.pk/index.php?e_name=" +
                this.city
        );
        this.getImages(data);
        if (this._isMounted) {
    ...
    getImages(data) {
        ...
        while (matches) {
            ...
            this.images.push("https://e.dunya.com.pk/" + link);
        }
    }
